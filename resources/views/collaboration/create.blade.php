...
@section('content')
    <section class="mx-auto max-w-3xl px-4 py-12">
        <h1 class="text-4xl font-semibold tracking-tight">{{ __('forms.collab_title') }}</h1>
        <p class="mt-3 text-slate-600">{{ __('forms.collab_subtitle') }}</p>
        ...
        <form method="POST" action="/{{ app()->getLocale() }}/collaboration/apply" class="mt-8 space-y-4">
            ...
            <div>
                <label class="text-sm font-medium">{{ __('forms.vat_number') }}</label>
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                    <label class="text-sm font-medium">{{ __('forms.country') }}</label>
