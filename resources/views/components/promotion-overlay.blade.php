...
@if (count($promotions) > 0)
    {{--
        Promotion payload — consumed by promotion-overlay.js
    ...
    {{--
        Overlay shell — content is injected by JS at runtime.
        aria-hidden="true" by default; set to "false" when opened.
